...
Public Class UOM
    ...
    Dim da As New SqlDataAdapter("select * from UOM", Login.cn)
    ...
    Private Sub UOM_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim da2 As New SqlClient.SqlDataAdapter("SELECT * FROM UOM WHERE UOM_ID='" & Val(TextBox1.Text) & "'", Login.cn)
        ds3.Clear()
        da2.Fill(ds3, "UOM")
    ...
    Private Sub Button8_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button8.Click
        ...
        Try
            ...
            cmd.CommandText = "update UOM set UOM_NAME='" & DataGridView1.CurrentRow.Cells(1).Value & "' where UOM_ID='" & DataGridView1.CurrentRow.Cells(0).Value & "'"
            cmd.Connection = Login.cn
            cmd.ExecuteNonQuery()
            MsgBox("Record sucessfully Updated", MsgBoxStyle.OkOnly, "INVENTORY")
            ds2.Clear()
            adap = New SqlDataAdapter("SELECT * FROM UOM", Login.cn)
            adap.Fill(ds2, "UOM")
    ...
    Private Sub TextBox9_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TextBox9.TextChanged
        ...
        Dim ds3 As New DataSet
        Dim da2 As New SqlClient.SqlDataAdapter("SELECT * FROM UOM WHERE UOM_NAME LIKE '" & TextBox9.Text & "%'", Login.cn)
        ds3.Clear()
        da2.Fill(ds3, "UOM")
        DataGridView1.DataSource = ds3.Tables(0)
        DataGridView1.Refresh()
    ...
    Private Sub Button9_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button9.Click
        ...
        Try
            ...
            If b = MsgBoxResult.Yes Then
                Dim ds2 As New DataSet
                Dim adap As SqlDataAdapter
                cmd.CommandText = "DELETE FROM UOM WHERE UOM_ID='" & DataGridView1.CurrentRow.Cells(0).Value & "'"
                cmd.Connection = Login.cn
                cmd.ExecuteNonQuery()
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        'CLEAR ALL TEXTBOXES
        Dim ds3 As New DataSet
        Dim da2 As New SqlClient.SqlDataAdapter("SELECT * FROM UOM ", Login.cn)
        ds3.Clear()
        da2.Fill(ds3, "UOM")
        DataGridView1.DataSource = ds3.Tables(0)
        DataGridView1.Refresh()
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        If TextBox2.Text = "" Then
            MsgBox("Enter UOM name", MsgBoxStyle.OkOnly, "INVENTORY")
            TextBox2.Focus()
            Exit Sub
        End If
        ...
        Dim da1 As New SqlClient.SqlDataAdapter("SELECT * FROM UOM ", Login.cn)
        ds1.Clear()
        da1.Fill(ds1, "UOM")
